...
namespace DataAccess
{
    public class UserDA
    {
        ...
        //public int AddPrinterProveder(PrinterProvered printerProvered)
        //{
        //    try
        //    {
        //        string insertQuery = "insert into PrinterProvider(PrinterMakerID,TimeStepFrom,TimeStepTo)values (@printerMakerID,@timeStepFrom,@timeStepTo)";
        //        SqlCommand cmd = new SqlCommand(insertQuery, con);

        //        //cmd.Parameters.AddWithValue("@printerMaker", printerProvered.PrinterMaker);
        //        cmd.Parameters.AddWithValue("@PrinterMakerID", printerProvered.PrinterMakerID);
        //        cmd.Parameters.AddWithValue("@timeStepFrom", printerProvered.TimeStepFrom);
        //        cmd.Parameters.AddWithValue("@timeStepTo", printerProvered.TimeStepTo);
