        ...
        <telerik:RadAjaxPanel ID="radAjxPanelMain" runat="server" LoadingPanelID="rad1" ClientEvents-OnRequestStart="mngRequestStarted">
            ...
            <div style="margin-top: 0; padding-left: 0; padding-right: 50px; overflow: auto;">
                    ...
                    <div class="container">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="auto-style1">
                                            <telerik:RadComboBox ID="txtprintermake" runat="server" DataSourceID="SqlDataSource1" DataTextField="PrinterMakeName" DataValueField="PrinterMakeID" Width="270px" EmptyMessage="Select Printer Make"></telerik:RadComboBox>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CompanyPrinterDB %>" SelectCommand="SELECT * FROM [Printers]"></asp:SqlDataSource>
