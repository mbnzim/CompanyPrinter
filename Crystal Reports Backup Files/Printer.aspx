            ...
            <div style="margin-top: 0; padding-left: 0; padding-right: 50px; overflow: auto;">
                <div>
                    ...
                    <div class="container">
                       ...
                       <%-- <telerik:RadButton ID="btnClear1" runat="server" Text="Clear"   AutoPostBack="false" OnClientClicked="ClearFilters();" Height="22px" ></telerik:RadButton>--%>
                  ...
                  <%--       <asp:Button Text="Clear Filters" runat="server" OnClientClick="ClearFilters(); return false;"  />--%>
                ...
                <telerik:RadWindow ID="addPrinterPopup" runat="server" NavigateUrl="~/addprinter_pop.aspx" VisibleStatusbar="False" Width="359px" OnClientClose="addPrinterPopup_Close" Height="311px"></telerik:RadWindow>
